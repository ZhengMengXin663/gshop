    ...
    <div class="info-content">
      ...
      <div class="bulletin">
        ...
        <div class="content-wrapper">
          <p class="content">是以粥为特色的中式营养快餐，自2004年10月18日创立“嘉和一品”品牌至今</p>
        </div>
        <ul class="supports">
          <li class="support-item" v-for="(support, index) in shopInfo.supports" :key="index"><span class="icon" :class="supportClasses[support.type]"></span> <span class="text">{{support.description}}</span></li>
        </ul>
      </div>
      ...
      <div class="pics">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" ref="picsUl">
            <li class="pic-item" v-for="(pic, index) in shopInfo.pics" :key="index"><img width="120" height="90" :src="pic"></li>
          </ul>
        </div>
      </div>
